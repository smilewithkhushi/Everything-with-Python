...
while(ch=='y' or ch=="Y"):
    ...
    lst_input=[int(x) for x in lst_input1]
    ...
    if (choice==1):
        ...
        if (result):
            ...
            max_string=maxString(lst_input1)
